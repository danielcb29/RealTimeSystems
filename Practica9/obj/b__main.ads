...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#d09d8306#;
   ...
   u00086 : constant Version_32 := 16#50ea431d#;
   pragma Export (C, u00086, "ada__real_time__delaysB");
   u00087 : constant Version_32 := 16#ad9f57fe#;
   pragma Export (C, u00087, "ada__real_time__delaysS");
   u00088 : constant Version_32 := 16#fd2ad2f1#;
   pragma Export (C, u00088, "gnatS");
   u00089 : constant Version_32 := 16#b48102f5#;
   pragma Export (C, u00089, "gnat__ioB");
   u00090 : constant Version_32 := 16#6227e843#;
   pragma Export (C, u00090, "gnat__ioS");
   u00091 : constant Version_32 := 16#608e2cd1#;
   pragma Export (C, u00091, "system__concat_5B");
   u00092 : constant Version_32 := 16#9a7907af#;
   pragma Export (C, u00092, "system__concat_5S");
   u00093 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00093, "system__concat_4B");
   u00094 : constant Version_32 := 16#63436fa1#;
   pragma Export (C, u00094, "system__concat_4S");
   u00095 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00095, "system__img_lldB");
   u00096 : constant Version_32 := 16#ee054de8#;
   pragma Export (C, u00096, "system__img_lldS");
   u00097 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00097, "system__img_decB");
   u00098 : constant Version_32 := 16#b30a4d5a#;
   pragma Export (C, u00098, "system__img_decS");
   u00099 : constant Version_32 := 16#1a9afbf1#;
   pragma Export (C, u00099, "system__tasking__stagesB");
   u00100 : constant Version_32 := 16#b3806b84#;
   pragma Export (C, u00100, "system__tasking__stagesS");
   u00101 : constant Version_32 := 16#12c8cd7d#;
   pragma Export (C, u00101, "ada__tagsB");
   u00102 : constant Version_32 := 16#ce72c228#;
   pragma Export (C, u00102, "ada__tagsS");
   u00103 : constant Version_32 := 16#c3335bfd#;
   pragma Export (C, u00103, "system__htableB");
   u00104 : constant Version_32 := 16#99e5f76b#;
   pragma Export (C, u00104, "system__htableS");
   u00105 : constant Version_32 := 16#089f5cd0#;
   pragma Export (C, u00105, "system__string_hashB");
   u00106 : constant Version_32 := 16#3bbb9c15#;
   pragma Export (C, u00106, "system__string_hashS");
   u00107 : constant Version_32 := 16#06052bd0#;
   pragma Export (C, u00107, "system__val_lluB");
   u00108 : constant Version_32 := 16#fa8db733#;
   pragma Export (C, u00108, "system__val_lluS");
   u00109 : constant Version_32 := 16#27b600b2#;
   pragma Export (C, u00109, "system__val_utilB");
   u00110 : constant Version_32 := 16#b187f27f#;
   pragma Export (C, u00110, "system__val_utilS");
   u00111 : constant Version_32 := 16#d1060688#;
   pragma Export (C, u00111, "system__case_utilB");
   u00112 : constant Version_32 := 16#392e2d56#;
   pragma Export (C, u00112, "system__case_utilS");
   u00113 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00113, "system__address_imageB");
   u00114 : constant Version_32 := 16#bccbd9bb#;
   pragma Export (C, u00114, "system__address_imageS");
   u00115 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00115, "system__restrictionsB");
   u00116 : constant Version_32 := 16#064fcfcf#;
   pragma Export (C, u00116, "system__restrictionsS");
   u00117 : constant Version_32 := 16#5eb4fbb1#;
   pragma Export (C, u00117, "system__tasking__initializationB");
   u00118 : constant Version_32 := 16#d9930fa8#;
   pragma Export (C, u00118, "system__tasking__initializationS");
   u00119 : constant Version_32 := 16#43c86425#;
   pragma Export (C, u00119, "system__soft_links__taskingB");
   u00120 : constant Version_32 := 16#e47ef8be#;
   pragma Export (C, u00120, "system__soft_links__taskingS");
   u00121 : constant Version_32 := 16#17d21067#;
   pragma Export (C, u00121, "ada__exceptions__is_null_occurrenceB");
   u00122 : constant Version_32 := 16#9a9e8fd3#;
   pragma Export (C, u00122, "ada__exceptions__is_null_occurrenceS");
   u00123 : constant Version_32 := 16#9b48686e#;
   pragma Export (C, u00123, "system__tasking__task_attributesB");
   u00124 : constant Version_32 := 16#952bcf5e#;
   pragma Export (C, u00124, "system__tasking__task_attributesS");
   u00125 : constant Version_32 := 16#d7130ad0#;
   ...
   u00127 : constant Version_32 := 16#1ae41921#;
   pragma Export (C, u00127, "system__tasking__protected_objectsB");
   u00128 : constant Version_32 := 16#63b50013#;
   pragma Export (C, u00128, "system__tasking__protected_objectsS");
   u00129 : constant Version_32 := 16#ee80728a#;
   pragma Export (C, u00129, "system__tracesB");
   u00130 : constant Version_32 := 16#ef3a2c2b#;
   pragma Export (C, u00130, "system__tracesS");
   u00131 : constant Version_32 := 16#7d7ec024#;
   pragma Export (C, u00131, "system__tasking__protected_objects__entriesB");
   u00132 : constant Version_32 := 16#7671a6ef#;
   pragma Export (C, u00132, "system__tasking__protected_objects__entriesS");
   u00133 : constant Version_32 := 16#b7ab275c#;
   pragma Export (C, u00133, "ada__finalizationB");
   u00134 : constant Version_32 := 16#19f764ca#;
   ...
   u00139 : constant Version_32 := 16#52d53711#;
   pragma Export (C, u00139, "system__finalization_rootS");
   u00140 : constant Version_32 := 16#7f10ce87#;
   ...
   u00142 : constant Version_32 := 16#3104380a#;
   pragma Export (C, u00142, "system__tasking__entry_callsB");
   u00143 : constant Version_32 := 16#e903595c#;
   pragma Export (C, u00143, "system__tasking__entry_callsS");
   u00144 : constant Version_32 := 16#2c5eeaff#;
   pragma Export (C, u00144, "system__tasking__protected_objects__operationsB");
   u00145 : constant Version_32 := 16#eb67f071#;
   pragma Export (C, u00145, "system__tasking__protected_objects__operationsS");
   u00146 : constant Version_32 := 16#8539b82b#;
   pragma Export (C, u00146, "system__tasking__utilitiesB");
   u00147 : constant Version_32 := 16#65f77ff8#;
   pragma Export (C, u00147, "system__tasking__utilitiesS");
   u00148 : constant Version_32 := 16#bd6fc52e#;
   pragma Export (C, u00148, "system__traces__taskingB");
   u00149 : constant Version_32 := 16#3fb127e5#;
   pragma Export (C, u00149, "system__traces__taskingS");
